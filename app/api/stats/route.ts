...
// Initialize stats from environment or defaults
if (typeof process.env.ICEBALL_STATS !== 'undefined') {
  try {
    stats = JSON.parse(process.env.ICEBALL_STATS);
  } catch (e) {
    // Use defaults
  }
}
...
// Export function to update stats (called from generate route)
